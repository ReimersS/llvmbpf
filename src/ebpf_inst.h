...
#define EBPF_OP_MOVSX_IMM (EBPF_CLS_ALU | EBPF_SRC_IMM | EBPF_ALU_OP_MOVSX)
#define EBPF_OP_MOVSX_REG (EBPF_CLS_ALU | EBPF_SRC_REG | EBPF_ALU_OP_MOVSX)
...
#define EBPF_OP_BYTESWAP (EBPF_CLS_ALU64 | EBPF_SRC_IMM | EBPF_ALU_OP_END)
...
#define EBPF_OP_MOVSX64_IMM (EBPF_CLS_ALU64 | EBPF_SRC_IMM | EBPF_ALU_OP_MOVSX)
#define EBPF_OP_MOVSX64_REG (EBPF_CLS_ALU64 | EBPF_SRC_REG | EBPF_ALU_OP_MOVSX)
...
#define EBPF_OP_JA_IMM (EBPF_CLS_JMP32 | EBPF_MODE_JA)
